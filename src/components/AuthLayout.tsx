...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="flex w-full max-w-6xl bg-white rounded-[2rem] shadow-2xl overflow-hidden min-h-[650px] flex-col md:flex-row border border-gray-100">
      ...
      <div className="relative w-full md:w-1/2 p-5">
        <div className="relative h-48 md:h-full w-full rounded-[1.5rem] overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-blue-900/40 via-blue-900/10 to-transparent"></div>
